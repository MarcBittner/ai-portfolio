...
[![Projects: 12](https://img.shields.io/badge/projects-12-blueviolet)](#live-demos)
...
environment variables. All eleven services run as free
...
All eleven services run as **free live demos on Render**, in offline mode (mock LLM
