...
# The routing modes the API/UI/diagnostics validate against (chain keys, ordered).
MODES: tuple[str, ...] = tuple(_CHAIN.keys())
...
def complete(system: str, user: str, *, offline: Callable[[str, str], str],
    ...
    for provider in chain:
        ...
        # Cap attempts per request so one call can't exceed the host's
