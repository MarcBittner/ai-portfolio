#!/usr/bin/env bash
# run.sh — dev/ops entrypoint for doc-extract (replaces make).
...
cmd_demo()  {
  ensure_installed
  py -c "from doc_extract.extract import extract; t='Invoice #: INV-7
Due date: 04/13/2026
Total due: \$1,284.50
email: a@b.com'; _,r=extract(t,'invoice'); print('
