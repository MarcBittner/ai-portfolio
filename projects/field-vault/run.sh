...
Commands:
  ...
  lint        Run ruff
  check       lint + test
  demo        Run the offline de-identification + access demo
...
cmd_demo()  { ensure_installed; py -m field_vault.demo; }
cmd_eval()  { ensure_installed; py -m field_vault.evaluate "$@"; }
