#!/usr/bin/env bash
# run.sh — dev/ops entrypoint for forecast (replaces make).
...
cmd_demo()  {
  ensure_installed
  py -c "from forecast.forecast import forecast; r=forecast([10,12,13,15,16,18,19,21,22,24],4); print('method',r['method'],'forecast',r['forecast'],'backtest',r['backtest'])"
}
