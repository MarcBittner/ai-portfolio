#!/usr/bin/env bash
# run.sh — dev/ops entrypoint for pii-redactor (replaces make).
...
cmd_demo()  {
  ensure_installed
  py -c "from pii_redactor.redact import redact; t='Email jane@example.com, SSN 123-45-6789, card 4111 1111 1111 1111.'; r,c=redact(t); print('IN :',t); print('OUT:',r); print('HIT:',c)"
}
