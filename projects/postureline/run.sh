...
Commands:
  ...
  lint        Run ruff
  check       lint + test
  demo        Run the offline demo: BOTH surfaces end-to-end
...
cmd_demo()  { ensure_installed; py -m postureline.demo; }
cmd_eval()  { ensure_installed; py -m postureline.evaluate "$@"; }
