...
def _call(provider: str, system: str, user: str, *, json_mode: bool,
    ...
    if provider in ("openai", "openrouter"):
        ...
        # OpenAI reliably honors response_format; on OpenRouter the model is
        # routed to an underlying provider that may 400 on it (free models
        # especially), so we rely on the prompt-instructed JSON + lenient parsing
        # there instead of forcing response_format.
